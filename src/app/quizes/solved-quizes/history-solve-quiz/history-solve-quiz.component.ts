...
@Component({
  selector: 'app-history-solve-quiz',
  imports: [
    NgIf,
    NgForOf
  ],
  templateUrl: './history-solve-quiz.component.html',
  standalone: true,
  styleUrl: './history-solve-quiz.component.css'
})
export class HistorySolveQuizComponent implements OnInit {
  questions: any[] = [];
  ...
  loadQuestions() {
    this.quizService.fetchHistoryQuizQuestions().subscribe(
      (response) => {
