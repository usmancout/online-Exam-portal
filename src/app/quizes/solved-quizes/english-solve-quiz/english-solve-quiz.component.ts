...
@Component({
  selector: 'app-english-solve-quiz',
  imports: [
    NgIf,
    NgForOf
  ],
  templateUrl: './english-solve-quiz.component.html',
  standalone: true,
  styleUrl: './english-solve-quiz.component.css'
})
export class EnglishSolveQuizComponent implements OnInit {
  ...
  loadQuestions() {
    this.quizService.fetchEnglishQuizQuestions().subscribe(
      (response) => {
